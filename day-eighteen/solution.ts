...
// Solution
type Counter<Tuple extends any[], Item, Count extends number[] = []> =
  Tuple extends [] 
    ? 
      Count['length'] 
    : 
    (
      Tuple extends [infer Head, ...infer Tail] 
        ? 
        (
          Head extends Item ? Counter<Tail, Item, [...Count, 1]> : Counter<Tail, Item, [...Count]>
        )
        : never
    );

type Count<Tuple extends any[], Item> = Counter<Tuple, Item, []>
